...
{
    [SerializeField]
    private CorridorFirstDungeonGenerator corridorSize;
    [SerializeField]
    ...
    private void CreateRooms()
    {
        ...
        if(randomWalkRooms)
        {
            floor = CreatesRoomsRandomly(roomList);
        }
        else
        {
    ...
    private HashSet<Vector2Int> CreatesRoomsRandomly(List<BoundsInt> roomList)
    {
        HashSet<Vector2Int> floor = new HashSet<Vector2Int>();
